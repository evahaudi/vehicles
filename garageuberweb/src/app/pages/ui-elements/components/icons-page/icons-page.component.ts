...
const SUPPLIER_DATA: SupplierList[] = [
  {id: 1, name: 'Hane Kane', total_orders: 1, route: 'H', actions:''},
  {id: 2, name: 'Jane Kane', total_orders: 4, route: 'He', actions:''},
  {id: 3, name: 'Calvin Kane', total_orders: 6, route: 'Li',  actions:''}
...
export class IconsPageComponent {
  displayedColumns: string[] = ['id', 'name', 'total_orders', 'route', 'actions'];
  ...
  public onAddSupplier(addForm: NgForm): void {
    this.supplierService.addSupplier(addForm.value).subscribe(
      (response: Supplier) => {
        ...
        alert("New supplier successfully added")
        addForm.reset();
      },
      (error: HttpErrorResponse) => {
        alert(error.message);
